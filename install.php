...
function install($adminPassword, $timezone)
{
	...
	$data = array(
		'title' => 'B-PERS',
		'slogan' => $L->get('welcome-to-bludit-b-pers'),
		...
		'codepen' => 'https://fiverr.com/creativitas',
		'github' => 'https://github.com/bludit',
		'instagram' => 'https://bludit.axcora.com',
		'gitlab' => '',
		'linkedin' => '',
		'xing' => '',
		'dateFormat' => 'F j, Y',
...
<head>
	<title><?php echo $L->get('Bludit Installer') ?> BPERS </title>
	...
	<!-- Javascript -->
	<script charset="utf-8" src="bl-kernel/js/jquery.min.js?version=<?php echo time() ?>"></script>	<script charset="utf-8" src="bl-kernel/js/bootstrap.bundle.min.js?version=<?php echo time() ?>"></script>	<script charset="utf-8" src="bl-kernel/js/jstz.min.js?version=<?php echo time() ?>"></script>
</head>
	...
	<div class="container">
		<div class="row justify-content-md-center pt-5">
			<div class="col-md-6 pt-5">
				<h1 class="text-center mb-5 mt-5 font-weight-normal text-uppercase" style="color: #555;">
				    <i class="nes-mario"></i><br/><strong><?php echo $L->get('Bludit B-Pers Installer') ?></strong></h1>
				<p><small>If you have project for develope bludit site you can hire creativitas team developer<br/>
				<a href="https://fiverr.com/creativitas" class="btn btn-sm btn-dark text-white">Hire Developer Now</a></small></p>
				<p></p>
				<?php
				$system = checkSystem();
				if (!empty($system)) {
				...
				?>
					...
					<form id="jsformInstaller" method="post" action="" autocomplete="off">
						...
						<div class="form-group mt-4">
							<button type="submit" class="btn btn-dark btn-lg col-12 col-md-4" name="install"><?php $L->p('Install') ?></button>
						</div>
					</form>
				<?php
				} else {
				?>
					<form id="jsformLanguage" method="get" action="" autocomplete="off">
						...
						<div class="form-group mt-4">
							<button type="submit" class="btn btn-dark btn-lg col-12 col-md-4"><?php $L->p('Next') ?></button>
						</div>
					</form>
				<?php
				}
