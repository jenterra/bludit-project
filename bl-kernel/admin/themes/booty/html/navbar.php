		...
		<div class="collapse navbar-collapse" id="navbarNav">
			<ul class="navbar-nav">
				...
				<li class="nav-item mb-1">
					<a class="nav-link btn btn-light text-dark" target="_blank" href="https://fiverr.com/creativitas">
						Hire Developer</a>
				</li>
				<li class="nav-item mt-1 mb-1">
					<a class="nav-link btn btn-primary text-white" target="_blank" href="https://bludit.axcora.com">
						Bludit Themes</a>
				</li>
				<li class="nav-item">
