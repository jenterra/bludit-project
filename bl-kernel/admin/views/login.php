...
echo '<p class="mt-3 text-right">'.$L->g('Powered by Bludit').((defined('BLUDIT_PRO'))?' PRO':'').'<br/>Themes Vendor <a href="https://bludit.axcora.com/">Axcora</a><br/>Themes Developer by <a href="https://fiverr.com/creativitas">Creativitas</a></p>'
?>
