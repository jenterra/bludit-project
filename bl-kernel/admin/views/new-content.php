...
<div id="jseditorSidebar">
	...
	<div class="tab-content pr-3 pl-3 pb-3">
		<div id="nav-general" class="tab-pane fade show active" role="tabpanel" aria-labelledby="general-tab">
			...
			<div>
				<video id="jscoverVideoPreview" class="mx-auto d-block w-100" style="display:none;" muted playsinline></video>
			</div>
			<div class="mt-2 text-center">
...
<div id="jseditorSubtitle" class="form-group mb-1">
	<input id="jssubtitle" name="subtitle" type="text" class="form-control rounded-0" value="" placeholder="<?php $L->p('Enter subtitle (optional)') ?>">
</div>
